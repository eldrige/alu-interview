...
needed to reach a target number of characters in a file, starting with a single character.
...
def minOperations(n):
    """
    Calculate the minimum number of operations to achieve n 'H' characters in the file.
    ...
    for i in range(2, int(math.sqrt(n)) + 1):
        # While n is divisible by i, divide n by i and increment operations count
        while n % i == 0:
            operations += i  # This represents 'Copy All' and multiple 'Paste' operations
            n //= i
